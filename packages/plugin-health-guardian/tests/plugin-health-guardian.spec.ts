...
import pluginHealthGuardianPlugin from "../dist/index.js";
import {
  createExpressApp,
...
describe("@dkg/plugin-health-guardian checks", function () {
  ...
  beforeEach(async () => {
    ...
    // Initialize plugin
    pluginHealthGuardianPlugin(mockDkgContext, mockMcpServer, apiRouter);
    await connect();
    app.use("/", apiRouter);
  });
  ...
  describe("Plugin Configuration", () => {
    it("should create plugin without errors", () => {
      expect(pluginHealthGuardianPlugin).to.be.a("function");
    });
  });
